...
#if defined(NDEBUG)
# error "TheCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "TheCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 25 * 60;
